...
for i in range(5):
    ...
    # directoryの作成
    log_dir = "Annealing_results_force_output_efficiency/{}".format(test_name)
    ...
    edges = [[pixel * origin_nodes_positions[edges_indice[0]], pixel * origin_nodes_positions[edges_indice[1]],
             ...
             for edges_indice, edge_thickness in zip(origin_edges_indices, origin_edges_thickness)]
    ...
    plt.axis("off")
    fig.savefig(os.path.join(log_dir, 'first_002.png'))
    plt.close()
    """
