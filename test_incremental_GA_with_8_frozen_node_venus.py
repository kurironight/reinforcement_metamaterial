...
fix_nodes_num = np.ones(free_nodes_num.shape, dtype=np.int) * 2
...
algorithm_type = Venus_FixNode_add_middle_point_NSGAII

if __name__ == "__main__":
    # define the problem definition
    save_dir = "GA/result/ハエトリグサ_単純GA_n6_epoch880"
    generation = 880
    save_interval = 5
